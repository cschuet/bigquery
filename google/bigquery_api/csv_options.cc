...
CsvOptions* CsvOptions::New() {
  return new client::JsonCppCapsule<CsvOptions>;
}

// Standard immutable constructor.
CsvOptions::CsvOptions(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
CsvOptions::CsvOptions(Json::Value* storage)
  : client::JsonCppData(storage) {
}
