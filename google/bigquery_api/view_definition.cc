...
ViewDefinition* ViewDefinition::New() {
  return new client::JsonCppCapsule<ViewDefinition>;
}

// Standard immutable constructor.
ViewDefinition::ViewDefinition(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
ViewDefinition::ViewDefinition(Json::Value* storage)
  : client::JsonCppData(storage) {
}
...
const client::JsonCppArray<UserDefinedFunctionResource > ViewDefinition::get_user_defined_function_resources() const {
...
client::JsonCppArray<UserDefinedFunctionResource > ViewDefinition::mutable_userDefinedFunctionResources() {
