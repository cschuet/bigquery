...
TimePartitioning* TimePartitioning::New() {
  return new client::JsonCppCapsule<TimePartitioning>;
}

// Standard immutable constructor.
TimePartitioning::TimePartitioning(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
TimePartitioning::TimePartitioning(Json::Value* storage)
  : client::JsonCppData(storage) {
}
