...
class TableDataInsertAllRequest : public client::JsonCppData {
 public:
  ...
  class TableDataInsertAllRequestRows : public client::JsonCppData {
   public:
    ...
    const char* GetTypeName() const {
      return "google_bigquery_api::TableDataInsertAllRequestRows";
    }
     ...
     */
    const std::string get_insert_id() const {
   ...
   */
  const char* GetTypeName() const {
    return "google_bigquery_api::TableDataInsertAllRequest";
  }
   ...
   */
  const std::string get_template_suffix() const {
   ...
   * @param[in] value The new value.
   */
  void set_template_suffix(const std::string& value) {
