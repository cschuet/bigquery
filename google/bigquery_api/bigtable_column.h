...
class BigtableColumn : public client::JsonCppData {
 public:
  ...
  const char* GetTypeName() const {
    return "google_bigquery_api::BigtableColumn";
  }
   ...
   */
  const std::string get_qualifier_encoded() const {
   ...
   * @param[in] value The new value.
   */
  void set_qualifier_encoded(const std::string& value) {
   ...
   */
  const std::string get_qualifier_string() const {
   ...
   * @param[in] value The new value.
   */
  void set_qualifier_string(const std::string& value) {
