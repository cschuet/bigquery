...
class JobConfigurationExtract : public client::JsonCppData {
 public:
  ...
  const char* GetTypeName() const {
    return "google_bigquery_api::JobConfigurationExtract";
  }
   ...
   */
  const std::string get_destination_format() const {
   ...
   * @param[in] value The new value.
   */
  void set_destination_format(const std::string& value) {
   ...
   */
  const std::string get_destination_uri() const {
   ...
   * @param[in] value The new value.
   */
  void set_destination_uri(const std::string& value) {
