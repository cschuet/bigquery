...
BigtableColumn* BigtableColumn::New() {
  return new client::JsonCppCapsule<BigtableColumn>;
}

// Standard immutable constructor.
BigtableColumn::BigtableColumn(const Json::Value& storage)
  : client::JsonCppData(storage) {
}

// Standard mutable constructor.
BigtableColumn::BigtableColumn(Json::Value* storage)
  : client::JsonCppData(storage) {
}
