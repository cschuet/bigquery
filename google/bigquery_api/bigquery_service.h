 ...
 *      <tr><th>API Rev<td>427
 *      <tr><th>API Docs
 *          <td><a href='https://cloud.google.com/bigquery/'>
 *              https://cloud.google.com/bigquery/</a>
 *      <tr><th>Discovery Name<td>bigquery
 *      <tr><th>Generated At<td>2019-03-01 03:01:16 UTC
...
class BigqueryServiceBaseRequest
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(BigqueryServiceBaseRequest);
};
...
class DatasetsResource_DeleteMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(DatasetsResource_DeleteMethod);
};
...
class DatasetsResource_GetMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  string project_id_;
  string dataset_id_;
  DISALLOW_COPY_AND_ASSIGN(DatasetsResource_GetMethod);
};
...
class DatasetsResource_InsertMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(DatasetsResource_InsertMethod);
};
...
class DatasetsResource_ListMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(DatasetsResource_ListMethod);
};
...
class DatasetsResource_PatchMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(DatasetsResource_PatchMethod);
};
...
class DatasetsResource_UpdateMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  string project_id_;
  string dataset_id_;  string _content_;
  DISALLOW_COPY_AND_ASSIGN(DatasetsResource_UpdateMethod);
};
...
class JobsResource_CancelMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(JobsResource_CancelMethod);
};
...
class JobsResource_GetMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  ...
  string location_;
  bool _have_location_ : 1;
  DISALLOW_COPY_AND_ASSIGN(JobsResource_GetMethod);
};
...
class JobsResource_GetQueryResultsMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(JobsResource_GetQueryResultsMethod);
};

typedef client::ServiceRequestPager<
            JobsResource_GetQueryResultsMethod,
            GetQueryResultsResponse>
        JobsResource_GetQueryResultsMethodPager;
...
class JobsResource_InsertMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  string project_id_;
  DISALLOW_COPY_AND_ASSIGN(JobsResource_InsertMethod);
};
...
class JobsResource_ListMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(JobsResource_ListMethod);
};
...
class JobsResource_QueryMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  string project_id_;  string _content_;
  DISALLOW_COPY_AND_ASSIGN(JobsResource_QueryMethod);
};
...
class ProjectsResource_GetServiceAccountMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  string project_id_;
  DISALLOW_COPY_AND_ASSIGN(ProjectsResource_GetServiceAccountMethod);
};
...
class ProjectsResource_ListMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  ...
  bool _have_max_results_ : 1;
  bool _have_page_token_ : 1;
  DISALLOW_COPY_AND_ASSIGN(ProjectsResource_ListMethod);
};
...
class TabledataResource_InsertAllMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(TabledataResource_InsertAllMethod);
};
...
class TabledataResource_ListMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  ...
  bool _have_start_index_ : 1;
  DISALLOW_COPY_AND_ASSIGN(TabledataResource_ListMethod);
};

typedef client::ServiceRequestPager<
            TabledataResource_ListMethod,
            TableDataList>
        TabledataResource_ListMethodPager;
...
class TablesResource_DeleteMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  ...
  string dataset_id_;
  string table_id_;
  DISALLOW_COPY_AND_ASSIGN(TablesResource_DeleteMethod);
};
...
class TablesResource_GetMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  ...
  string selected_fields_;
  bool _have_selected_fields_ : 1;
  DISALLOW_COPY_AND_ASSIGN(TablesResource_GetMethod);
};
...
class TablesResource_InsertMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  string project_id_;
  string dataset_id_;  string _content_;
  DISALLOW_COPY_AND_ASSIGN(TablesResource_InsertMethod);
};
...
class TablesResource_ListMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  ...
  bool _have_max_results_ : 1;
  bool _have_page_token_ : 1;
  DISALLOW_COPY_AND_ASSIGN(TablesResource_ListMethod);
};
...
class TablesResource_PatchMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  ...
  string dataset_id_;
  string table_id_;  string _content_;
  DISALLOW_COPY_AND_ASSIGN(TablesResource_PatchMethod);
};
...
class TablesResource_UpdateMethod : public BigqueryServiceBaseRequest {
 ...
 private:
  ...
  string dataset_id_;
  string table_id_;  string _content_;
  DISALLOW_COPY_AND_ASSIGN(TablesResource_UpdateMethod);
};
...
class BigqueryService : public client::ClientService {
 public:
  ...
  class DatasetsResource {
   public:
    ...
    DatasetsResource_DeleteMethod* NewDeleteMethod(
        client::AuthorizationCredential* _credential_,
        const absl::string_view& project_id,
        const absl::string_view& dataset_id) const;
    ...
    DatasetsResource_ListMethod* NewListMethod(
        client::AuthorizationCredential* _credential_,
        const absl::string_view& project_id) const;
   ...
   private:
    ...
    DISALLOW_COPY_AND_ASSIGN(DatasetsResource);
  };
  ...
  class JobsResource {
   public:
    ...
    JobsResource_CancelMethod* NewCancelMethod(
        client::AuthorizationCredential* _credential_,
        const absl::string_view& project_id,
        const absl::string_view& job_id) const;
     ...
     * @see googleapis::googleapis::ServiceRequestPager
     */
    JobsResource_GetQueryResultsMethodPager* NewGetQueryResultsMethodPager(
        client::AuthorizationCredential* _credential_,
        const absl::string_view& project_id,
        const absl::string_view& job_id) const;
   ...
   private:
    ...
    DISALLOW_COPY_AND_ASSIGN(JobsResource);
  };
  ...
  class TabledataResource {
   public:
    ...
    TabledataResource_ListMethod* NewListMethod(
        ...
        const absl::string_view& project_id,
        const absl::string_view& dataset_id,
        const absl::string_view& table_id) const;
     ...
     * @see googleapis::googleapis::ServiceRequestPager
     */
    TabledataResource_ListMethodPager* NewListMethodPager(
        client::AuthorizationCredential* _credential_,
        const absl::string_view& project_id,
        const absl::string_view& dataset_id,
        const absl::string_view& table_id) const;
   ...
   private:
    ...
    DISALLOW_COPY_AND_ASSIGN(TabledataResource);
  };
  ...
  class TablesResource {
   ...
   private:
    ...
    DISALLOW_COPY_AND_ASSIGN(TablesResource);
  };
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(BigqueryService);
};
