...
DatasetsResource_DeleteMethod::DatasetsResource_DeleteMethod(
    const BigqueryService* _service_, client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id)
...
util::Status DatasetsResource_DeleteMethod::AppendOptionalQueryParameters(string* target) {
  ...
  if (_have_delete_contents_) {
    StrAppend(target, sep, "deleteContents=",
              client::CppValueToEscapedUrlValue(
                delete_contents_));
    sep = "&";
  }
...
DatasetsResource_InsertMethod::DatasetsResource_InsertMethod(
    const BigqueryService* _service_, client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const Dataset& __request_content__)
    : BigqueryServiceBaseRequest(
        _service_, _credential_,
...
DatasetsResource_ListMethod::DatasetsResource_ListMethod(
    const BigqueryService* _service_, client::AuthorizationCredential* _credential_, const absl::string_view& project_id)
    : BigqueryServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::GET,
        "projects/{projectId}/datasets"),
...
DatasetsResource_PatchMethod::DatasetsResource_PatchMethod(
    const BigqueryService* _service_, client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id, const Dataset& __request_content__)
    : BigqueryServiceBaseRequest(
        _service_, _credential_,
...
JobsResource_CancelMethod::JobsResource_CancelMethod(
    const BigqueryService* _service_, client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& job_id)
    : BigqueryServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
...
util::Status JobsResource_GetQueryResultsMethod::AppendOptionalQueryParameters(string* target) {
  ...
  if (_have_timeout_ms_) {
    StrAppend(target, sep, "timeoutMs=",
              client::CppValueToEscapedUrlValue(
                timeout_ms_));
    sep = "&";
  }
...
// Standard constructor.
JobsResource_InsertMethod::JobsResource_InsertMethod(
    const BigqueryService* _service_, client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const Job* _metadata_, const StringPiece& _media_content_type_, client::DataReader* _media_content_reader_)
    : BigqueryServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
        "projects/{projectId}/jobs"),
...
util::Status JobsResource_ListMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_all_users_) {
    StrAppend(target, sep, "allUsers=",
              client::CppValueToEscapedUrlValue(
                all_users_));
    sep = "&";
  }
  if (_have_max_creation_time_) {
    StrAppend(target, sep, "maxCreationTime=",
              client::CppValueToEscapedUrlValue(
                max_creation_time_));
    sep = "&";
  }
  ...
  if (_have_min_creation_time_) {
    StrAppend(target, sep, "minCreationTime=",
              client::CppValueToEscapedUrlValue(
                min_creation_time_));
    sep = "&";
  }
  ...
  if (_have_parent_job_id_) {
    StrAppend(target, sep, "parentJobId=",
              client::CppValueToEscapedUrlValue(
                parent_job_id_));
    sep = "&";
  }
...
JobsResource_QueryMethod::JobsResource_QueryMethod(
    const BigqueryService* _service_, client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const QueryRequest& __request_content__)
    : BigqueryServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
...
TabledataResource_InsertAllMethod::TabledataResource_InsertAllMethod(
    const BigqueryService* _service_, client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id, const absl::string_view& table_id, const TableDataInsertAllRequest& __request_content__)
    : BigqueryServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
...
TabledataResource_ListMethod::TabledataResource_ListMethod(
    const BigqueryService* _service_, client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id, const absl::string_view& table_id)
    : BigqueryServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::GET,
...
util::Status TabledataResource_ListMethod::AppendOptionalQueryParameters(string* target) {
  ...
  if (_have_selected_fields_) {
    StrAppend(target, sep, "selectedFields=",
              client::CppValueToEscapedUrlValue(
                selected_fields_));
    sep = "&";
  }
...
TablesResource_InsertMethod::TablesResource_InsertMethod(
    const BigqueryService* _service_, client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id, const Table& __request_content__)
    : BigqueryServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
...
TablesResource_PatchMethod::TablesResource_PatchMethod(
    const BigqueryService* _service_, client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id, const absl::string_view& table_id, const Table& __request_content__)
    : BigqueryServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::PATCH,
        "projects/{projectId}/datasets/{datasetId}/tables/{tableId}"),
...
DatasetsResource_DeleteMethod* BigqueryService::DatasetsResource::NewDeleteMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id) const {
  return new DatasetsResource_DeleteMethod(service_, _credential_, project_id, dataset_id);
}


DatasetsResource_GetMethod* BigqueryService::DatasetsResource::NewGetMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id) const {
  return new DatasetsResource_GetMethod(service_, _credential_, project_id, dataset_id);
}


DatasetsResource_InsertMethod* BigqueryService::DatasetsResource::NewInsertMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const Dataset& __request_content__) const {
  return new DatasetsResource_InsertMethod(service_, _credential_, project_id, __request_content__);
}


DatasetsResource_ListMethod* BigqueryService::DatasetsResource::NewListMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id) const {
  return new DatasetsResource_ListMethod(service_, _credential_, project_id);
}


DatasetsResource_ListMethodPager* BigqueryService::DatasetsResource::NewListMethodPager(client::AuthorizationCredential* _credential_, const absl::string_view& project_id) const {
...
DatasetsResource_PatchMethod* BigqueryService::DatasetsResource::NewPatchMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id, const Dataset& __request_content__) const {
  return new DatasetsResource_PatchMethod(service_, _credential_, project_id, dataset_id, __request_content__);
}


DatasetsResource_UpdateMethod* BigqueryService::DatasetsResource::NewUpdateMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id, const Dataset& __request_content__) const {
...
JobsResource_CancelMethod* BigqueryService::JobsResource::NewCancelMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& job_id) const {
  return new JobsResource_CancelMethod(service_, _credential_, project_id, job_id);
}


JobsResource_GetMethod* BigqueryService::JobsResource::NewGetMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& job_id) const {
  return new JobsResource_GetMethod(service_, _credential_, project_id, job_id);
}


JobsResource_GetQueryResultsMethod* BigqueryService::JobsResource::NewGetQueryResultsMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& job_id) const {
  return new JobsResource_GetQueryResultsMethod(service_, _credential_, project_id, job_id);
}


JobsResource_GetQueryResultsMethodPager* BigqueryService::JobsResource::NewGetQueryResultsMethodPager(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& job_id) const {
  return new client::EncapsulatedServiceRequestPager<JobsResource_GetQueryResultsMethod, GetQueryResultsResponse>(new JobsResource_GetQueryResultsMethod(service_, _credential_, project_id, job_id));
}
...
JobsResource_InsertMethod* BigqueryService::JobsResource::NewInsertMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id) const {
  return new JobsResource_InsertMethod(service_, _credential_, project_id);
}

JobsResource_InsertMethod* BigqueryService::JobsResource::NewInsertMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const Job* _metadata_, const StringPiece& _media_content_type_, client::DataReader* _media_content_reader_) const {
...
JobsResource_ListMethod* BigqueryService::JobsResource::NewListMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id) const {
  return new JobsResource_ListMethod(service_, _credential_, project_id);
}


JobsResource_ListMethodPager* BigqueryService::JobsResource::NewListMethodPager(client::AuthorizationCredential* _credential_, const absl::string_view& project_id) const {
...
JobsResource_QueryMethod* BigqueryService::JobsResource::NewQueryMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const QueryRequest& __request_content__) const {
...
ProjectsResource_GetServiceAccountMethod* BigqueryService::ProjectsResource::NewGetServiceAccountMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id) const {
...
TabledataResource_InsertAllMethod* BigqueryService::TabledataResource::NewInsertAllMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id, const absl::string_view& table_id, const TableDataInsertAllRequest& __request_content__) const {
  return new TabledataResource_InsertAllMethod(service_, _credential_, project_id, dataset_id, table_id, __request_content__);
}


TabledataResource_ListMethod* BigqueryService::TabledataResource::NewListMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id, const absl::string_view& table_id) const {
  return new TabledataResource_ListMethod(service_, _credential_, project_id, dataset_id, table_id);
}


TabledataResource_ListMethodPager* BigqueryService::TabledataResource::NewListMethodPager(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id, const absl::string_view& table_id) const {
  return new client::EncapsulatedServiceRequestPager<TabledataResource_ListMethod, TableDataList>(new TabledataResource_ListMethod(service_, _credential_, project_id, dataset_id, table_id));
}
...
TablesResource_DeleteMethod* BigqueryService::TablesResource::NewDeleteMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id, const absl::string_view& table_id) const {
  return new TablesResource_DeleteMethod(service_, _credential_, project_id, dataset_id, table_id);
}


TablesResource_GetMethod* BigqueryService::TablesResource::NewGetMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id, const absl::string_view& table_id) const {
  return new TablesResource_GetMethod(service_, _credential_, project_id, dataset_id, table_id);
}


TablesResource_InsertMethod* BigqueryService::TablesResource::NewInsertMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id, const Table& __request_content__) const {
  return new TablesResource_InsertMethod(service_, _credential_, project_id, dataset_id, __request_content__);
}


TablesResource_ListMethod* BigqueryService::TablesResource::NewListMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id) const {
  return new TablesResource_ListMethod(service_, _credential_, project_id, dataset_id);
}


TablesResource_ListMethodPager* BigqueryService::TablesResource::NewListMethodPager(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id) const {
...
TablesResource_PatchMethod* BigqueryService::TablesResource::NewPatchMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id, const absl::string_view& table_id, const Table& __request_content__) const {
  return new TablesResource_PatchMethod(service_, _credential_, project_id, dataset_id, table_id, __request_content__);
}


TablesResource_UpdateMethod* BigqueryService::TablesResource::NewUpdateMethod(client::AuthorizationCredential* _credential_, const absl::string_view& project_id, const absl::string_view& dataset_id, const absl::string_view& table_id, const Table& __request_content__) const {
